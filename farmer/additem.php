            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="controller/additemfile.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="quantity" id="exampleInputUsername2" placeholder="quantity" required>
                        </div>
                      </div>
                      <div class="form-group row">
