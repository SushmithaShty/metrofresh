            ...
            <div class="row">
              <div class="col-lg-12  grid-margin stretch-card">
                ...
                <?php 
                                        ...
                                        $st=$admin->ret("SELECT * FROM `order_details` INNER JOIN `items` ON items.i_id=order_details.i_id INNER JOIN `orders` ON order_details.o_id=orders.o_id INNER JOIN `customer` ON orders.c_id=customer.c_id ORDER BY orders.o_id DESC");
