...
?>
                                ...
                                <div class="panel-body">
                                    <table class="table table-hover" style="background-color:#EBF4FA">
                                        ...
                                        <tbody>
                                            <?php 
                                            $stmt=$admin->ret("SELECT * FROM `order_details` INNER JOIN `products` ON products.p_id=order_details.p_id INNER JOIN `orders` ON order_details.o_id=orders.o_id INNER JOIN `farmer` ON orders.f_id=farmer.f_id WHERE `date` BETWEEN '$s_date' AND '$f_date' ");
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../metro_fresh/image/<?php echo $row['p_img']?>" width="75px" height="75px"></td>
